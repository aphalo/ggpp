...
+-------------------------------+---------------------+----------------------+
| `geom_label_s()` *(planned)*  |                     | `character`          |
+-------------------------------+---------------------+----------------------+
| `geom_point_s()`              |                     |                      |
+-------------------------------+---------------------+----------------------+
...
+-------------------------------+---------------------+----------------------+
| `geom_raster()`  *(planned)*  | `geom_raster_npc()` | `list(<raster>)`     |
+-------------------------------+---------------------+----------------------+
