...
+----------------------------+--------------------+--------------------+
| Data labels (data          | Annotations (npc)  | Mapped to `label`  |
| coordinates)               |                    |                    |
+============================+====================+====================+
...
+----------------------------+--------------------+--------------------+
| *`ggr                      |                    | `character` vector |
| epe l::geom_text_repel()`* |                    |                    |
+----------------------------+--------------------+--------------------+
| *`ggre                     |                    | `character` vector |
| pel ::geom_label_repel()`* |                    |                    |
+----------------------------+--------------------+--------------------+
| *`geom_text_s()`*          |                    | `character` vector |
+----------------------------+--------------------+--------------------+
| geom_label_s() (planned)   |                    | `character` vector |
+----------------------------+--------------------+--------------------+
| *`geom_point_s()`*         |                    | none               |
+----------------------------+--------------------+--------------------+
| *`geom_plot()`*            | `geom_plot_npc()`  | `list()` of        |
|                            |                    | `ggplot2::gg`      |
+----------------------------+--------------------+--------------------+
| *`geom_table()`*           | `geom_table_npc()` | `list()` of        |
|                            |                    | `data.frame`       |
+----------------------------+--------------------+--------------------+
| *`geom_grob()`*            | `geom_grob_npc()`  | `list()` of        |
|                            |                    | `grid::grob`       |
+----------------------------+--------------------+--------------------+
...
| `ggrepel::postion_nudge_keep()`       | `ggplot2::position_nudge()`       |
...
position functions available in 'ggplot2'. In the first example we label
